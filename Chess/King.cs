namespace Chess
{
    ...
    {
        public King(string color, string name, short xLocation, short yLocation, Player player)
        ...
        public override bool CanMoveTo(Board board, short xLocationTo, short yLocationTo, Stone stone)
        {
            ...
            {
                if ((Math.Abs(Ylocation - yLocationTo) <= 1 && Math.Abs(Xlocation - xLocationTo) <= 1)) // At L gider
                {
                    return true;
                }
