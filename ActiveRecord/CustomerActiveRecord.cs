...
namespace ActiveRecord
{
    public class CustomerActiveRecord
    {
        ...
        public CustomerActiveRecord(string firstName, string lastName, DateTime birthDate, string country)
        {
            FirstName = firstName;
            LastName = lastName;
            BirthDate = birthDate;
        ...
        {
            Console.WriteLine("Müşteri business ada göre getirildi.");
            return null;
        }

        public SqlDataReader GetCustomerByBusinessRule()
        {
